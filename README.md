...
<table>
  <tr>
    <td width="33%" valign="top">
      <img src="./GarfO&amp;Go.png" alt="Interface do projeto Garfo & Go" />
      <h3>Garfo & Go</h3>
      <p>Proposta de um sistema de pedidos de comida para tornar o pedido pelo celular mais rápido e prático.</p>
    </td>
    <td width="33%" valign="top">
      <img src="./Golady.png" alt="Interface do projeto Go Lady" />
      <h3>Go Lady</h3>
    ...
    <td width="33%" valign="top">
      <img src="./FisioCare.png" alt="Interface do projeto Fisio Care" />
      <h3>Fisio Care</h3>
